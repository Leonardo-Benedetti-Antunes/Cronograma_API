...
public interface SalaUseCase {
    ...
    public void atualizarCategoria(int id, int categoriaID); //Atualiza a categoria de alguma sala
    public void deletarCategoria(int id); //Deleta a vinculação entre sala e categoria
    ...
    public void atualizarTurma(int id, int salaID); //Em construção...
    ...
    public void atualizarMateria(int id, int materiaID); // Em construção...
